...
const Education = () => {
  return (
    <Layout>
 <div className="bg-100   text-blue w-3/5 mx-auto">
 <div className="text-center mt-14">
      ...
      <div className='grid grid-cols-2 gap-4'>
        ...
        <div className="cs font-bold " >
          <h2 className="inline-block border-b-2 border-purple">Computer Science Courses</h2>
          <ul className="">
        ...
        <div className="ds font-bold"> <h2 className="inline-block border-b-2 border-purple">Data Science Courses</h2>
        <ul>
          ...
          <div className="font-bold"><h1 className='inline-block border-b-2 border-purple'>Math Courses</h1>
        <ul>
          ...
          <li> Nonlinear and Discrete Optimization(INDENG 160)</li>
          </ul>
        </div>
        </div>

          <div className="font-bold ">
              <h1 className='inline-block border-b-2 border-purple'>Course Projects</h1>
              <ul>
                ...
                <li>snek(C) [CS61C]</li>
                <li>CS61Classify(C) [CS61C]</li>
                <li>CS61CPU(RISCV) [CS61C]</li>
                <li>CS61kaChow(C) [CS61C]</li>
